...
public class RSAEncrypt {
    ...
    public void getFromAssets(Context context) {
        try {
            InputStreamReader inputReader = new InputStreamReader(context.getResources().getAssets().open("rsa_public_key.pem"));
    ...
    public byte[] encryptByte(byte[] sourceData) {
        String result = "";
        try {
            byte[] cipher = encrypt(publicKey, sourceData);
            return cipher;
