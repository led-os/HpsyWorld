...
import com.rayhahah.rbase.fragmentmanage.SupportFragmentDelegate;
...
public abstract class RBaseFragment<T extends RBasePresenter>
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (mRootView == null) {
            mRootView = inflater.inflate(setFragmentLayoutRes(), null, false);
