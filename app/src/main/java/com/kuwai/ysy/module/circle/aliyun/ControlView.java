...
import com.kuwai.ysy.utils.UIConfigManager;
...
//                    findViewById(R.id.iv_gif_effect)
    ...
    private void setViewListener() {
        mPickerView.setOnSelectedListener(new ScrollPickerView.OnSelectedListener() {
            @Override
