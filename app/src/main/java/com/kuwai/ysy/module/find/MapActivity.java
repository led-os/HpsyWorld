...
public class MapActivity extends BaseActivity implements AMap.OnMapLoadedListener, AMap.OnMapClickListener, LocationSource, AMapLocationListener {
    private AMap aMap;
    ...
    private void init() {
        ...
        if (!Utils.isNullString(mLat)) {
            LatLng mylocation = new LatLng(Double.parseDouble(mLat), Double.parseDouble(mLon));
    ...
    private void addLocationMarker(LatLng latLng) {
        ...
        if (locMarker == null) {
            ...
            ac = aMap.addCircle(new CircleOptions().center(mylocation)
                    .fillColor(Color.argb(100, 255, 218, 185)).radius(10)
            ...
            c = aMap.addCircle(new CircleOptions().center(mylocation)
                    ...
                    .radius(10)
                    .strokeColor(Color.argb(255, 255, 228, 185))
                    .strokeWidth(0));
        } else {
