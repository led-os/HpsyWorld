...
public class AddressChooseFragment extends BaseFragment implements LocationSource,
    ...
    private String searchType = "050000";
    ...
    public void initView(Bundle savedInstanceState) {
        left = mRootView.findViewById(R.id.img_left);
        mSearchText = mRootView.findViewById(R.id.et_search);
        ...
        if ("运动".equals(SPManager.get().getStringValue("meet_type"))) {
            searchKey = "运动场";
            searchType = "";
        } else if ("唱歌".equals(SPManager.get().getStringValue("meet_type"))) {
            searchKey = "KTV";
            searchType = "";
        }else if ("游乐".equals(SPManager.get().getStringValue("meet_type"))) {
            searchKey = "游乐|网吧|夜店|棋牌室|动物园|水上乐园|主题公园";
            searchType = "";
        } else if ("其他".equals(SPManager.get().getStringValue("meet_type"))) {
            searchKey = "";
            searchType = "";
        }
        init();
        listView = (RecyclerView) mRootView.findViewById(R.id.listview);
        searchResultAdapter = new MapAdapter();
        ...
        searchResultAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                //Intent aintent = new Intent(getActivity(), PublishDyActivity.class);
        ...
        mSearchText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    ...
                    searchKey = mSearchText.getText().toString();
                    doSearchQuery();
                    return true;
                }
                return false;
...
//        Log.i("MY", "onLocationChanged");
    ...
    private void getInfo(AMapLocation amapLocation) {
...
//        Log.i("MY", "doSearchQuery");
    ...
    private void updateListview(List<PoiItem> poiItems) {
        ...
        searchResultAdapter.addData(poiItems);
