...
public class AlivcSvideoRecordActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        videoRecordView.setPickPhotoListener(new AliyunSVideoRecordView.OnPickPhotoListener() {
            @Override
            public void onComplete(String path) {
                Intent intent = new Intent(AlivcSvideoRecordActivity.this, PublishDyActivity.class);
