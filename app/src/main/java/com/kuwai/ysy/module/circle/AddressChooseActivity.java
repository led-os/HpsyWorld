...
public class AddressChooseActivity extends AppCompatActivity implements LocationSource,
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchAddressAdapter(AddressChooseActivity.this);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(AddressChooseActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(AddressChooseActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(AddressChooseActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
...
//            if (position != searchResultAdapter.getSelectedPosition()) {
                ...
                aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(curLatlng, 16f));
                Intent aintent = new Intent(AddressChooseActivity.this, PublishDyActivity.class);
                aintent.putExtra("data", poiItem);
