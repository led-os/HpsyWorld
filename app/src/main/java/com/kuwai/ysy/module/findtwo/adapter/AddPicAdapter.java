...
public class AddPicAdapter extends RecyclerView.Adapter<AddPicAdapter.ViewHolder> {
    ...
    public AddPicAdapter(OnAddItemClickListener itemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final ViewHolder viewHolder = new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_nine_photo, parent, false));
            ...
            ivPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ImagePreview
                            ...
                            .setImage(mList.get(pos).getCompressPath())
