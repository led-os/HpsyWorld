...
@MessageTag(value = "YSY:sendgift", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class GiftSendMessage extends MessageContent {
    ...
    public GiftSendMessage() {
    }

    public static GiftSendMessage obtain(String text) {
        GiftSendMessage model = new GiftSendMessage();
        model.setContent(text);
        return model;
    }

    public GiftSendMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public GiftSendMessage(Parcel in) {
     ...
     */
    public static final Creator<GiftSendMessage> CREATOR = new Creator<GiftSendMessage>() {

        @Override
        public GiftSendMessage createFromParcel(Parcel source) {
            return new GiftSendMessage(source);
        }

        @Override
        public GiftSendMessage[] newArray(int size) {
            return new GiftSendMessage[size];
        }
    };
     ...
     */
    public GiftSendMessage(String content) {
