...
@MessageTag(value = "YSY:redpocketreceive", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class RedReceiveMessage extends MessageContent {
    ...
    public RedReceiveMessage() {
    }

    public static RedReceiveMessage obtain(String text) {
        RedReceiveMessage model = new RedReceiveMessage();
        model.setContent(text);
        return model;
    }

    public RedReceiveMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public RedReceiveMessage(Parcel in) {
     ...
     */
    public static final Creator<RedReceiveMessage> CREATOR = new Creator<RedReceiveMessage>() {

        @Override
        public RedReceiveMessage createFromParcel(Parcel source) {
            return new RedReceiveMessage(source);
        }

        @Override
        public RedReceiveMessage[] newArray(int size) {
            return new RedReceiveMessage[size];
        }
    };
     ...
     */
    public RedReceiveMessage(String content) {
