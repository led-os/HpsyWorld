...
@MessageTag(value = "YSY:chatquestion", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class QuestionMessage extends MessageContent {
    ...
    public static QuestionMessage obtain(String text) {
        QuestionMessage model = new QuestionMessage();
    ...
    public static final Creator<QuestionMessage> CREATOR = new Creator<QuestionMessage>() {
        ...
        @Override
        public QuestionMessage createFromParcel(Parcel source) {
            return new QuestionMessage(source);
        }
     ...
     */
    public QuestionMessage(String content) {
