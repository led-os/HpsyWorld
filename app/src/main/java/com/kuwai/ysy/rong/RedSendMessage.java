...
public class RedSendMessage extends MessageContent {
    ...
    public RedSendMessage() {
    }

    public static RedSendMessage obtain(String text) {
        RedSendMessage model = new RedSendMessage();
        model.setContent(text);
        return model;
    }

    public RedSendMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public RedSendMessage(Parcel in) {
     ...
     */
    public static final Creator<RedSendMessage> CREATOR = new Creator<RedSendMessage>() {

        @Override
        public RedSendMessage createFromParcel(Parcel source) {
            return new RedSendMessage(source);
        }

        @Override
        public RedSendMessage[] newArray(int size) {
            return new RedSendMessage[size];
        }
    };
     ...
     */
    public RedSendMessage(String content) {
