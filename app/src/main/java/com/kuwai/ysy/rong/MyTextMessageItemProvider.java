...
public class MyTextMessageItemProvider extends TextMessageItemProvider{
    ...
    public void bindView(final View v, int position, TextMessage content, final UIMessage data) {
        ...
        if (data.getMessageDirection() == Message.MessageDirection.SEND) {
            ...
            holder.message.setTextColor(v.getContext().getResources().getColor(R.color.white));
        } else {
            holder.message.setBackgroundResource(R.drawable.rc_ic_bubble_left);
            holder.message.setTextColor(v.getContext().getResources().getColor(R.color.balck_28));
        }
