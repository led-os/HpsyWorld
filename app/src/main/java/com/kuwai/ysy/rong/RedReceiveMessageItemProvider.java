...
@ProviderTag(
        messageContent = RedReceiveMessage.class,
        showProgress = false,
        showWarning = false
)
public class RedReceiveMessageItemProvider extends IContainerItemProvider.MessageProvider<RedReceiveMessage> {
    ...
    public View newView(Context context, ViewGroup group) {
        View view = LayoutInflater.from(context).inflate(R.layout.rong_repack_other, null);

        RedReceiveMessageItemProvider.ViewHolder holder = new RedReceiveMessageItemProvider.ViewHolder();
    ...
    @Override
    public Spannable getContentSummary(RedReceiveMessage data) {
        return null;
    }

    @Override
    public Spannable getContentSummary(Context context, RedReceiveMessage data) {
        if (data == null)
            return null;
    ...
    @Override
    public void onItemClick(View view, int position, RedReceiveMessage content, UIMessage message) {
    ...
    @Override
    public void onItemLongClick(final View view, int position, final RedReceiveMessage content, final UIMessage message) {

        RedReceiveMessageItemProvider.ViewHolder holder = (RedReceiveMessageItemProvider.ViewHolder) view.getTag();
        ...
        OptionsPopupDialog.newInstance(view.getContext(), items).setOptionsPopupDialogListener(new OptionsPopupDialog.OnOptionsItemClickedListener() {
            ...
            public void onOptionsItemClicked(int which) {
                if (which == 0) {
                    ...
                    clipboard.setText(((RedReceiveMessage) content).getContent());
                } else if (which == 1) {
    ...
    @Override
    public void bindView(final View v, int position, final RedReceiveMessage content, final UIMessage data) {
