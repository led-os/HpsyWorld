package com.kuwai.ysy.utils.security;
...
public class RSAEncrypt {
    ...
    private RSAEncrypt getInstance(Context context){
        return new RSAEncrypt("rsa_public_key.pem",context);
    }

    public RSAEncrypt(String in, Context context) {
        try {
            getFromAssets(in, context);
        } catch (Exception e) {
        }
    }
    ...
    public void getFromAssets(String fileName, Context context) {
        try {
