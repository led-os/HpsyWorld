...
public class BannerRound extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.banner_round;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        viewPager.setOffscreenPageLimit(3);//预加载2个
        viewPager.setPageMargin(1);//设置viewpage之间的间距
    ...
    public BannerRound setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
