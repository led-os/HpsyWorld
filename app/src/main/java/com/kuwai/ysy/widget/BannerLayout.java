...
import com.kuwai.ysy.widget.layoutmanager.BannerLayoutManager;
import com.kuwai.ysy.widget.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        params.setMargins(marginLeft, 100, marginRight, marginBottom);
