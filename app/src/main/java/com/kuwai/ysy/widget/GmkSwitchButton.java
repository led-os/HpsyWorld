...
public class GmkSwitchButton extends CompoundButton {
    ...
    public GmkSwitchButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public GmkSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
        invalidate();
    }

    public GmkSwitchButton(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.GmkSwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.GmkSwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.GmkSwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.GmkSwitchButton_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.GmkSwitchButton_kswBackRadius, thumbRadius + density * 2f);
            backDrawable = ta.getDrawable(R.styleable.GmkSwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.GmkSwitchButton_kswBackColor);
            backMeasureRatio = ta.getFloat(R.styleable.GmkSwitchButton_kswBackMeasureRatio, backMeasureRatio);
            animationDuration = ta.getInteger(R.styleable.GmkSwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.GmkSwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.GmkSwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.GmkSwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.GmkSwitchButton_kswTextOff);
            textMarginH = Math.max(textMarginH, backRadius / 2);
            textMarginH = ta.getDimension(R.styleable.GmkSwitchButton_kswTextMarginH, textMarginH);
            autoAdjustTextPosition = ta.getBoolean(R.styleable.GmkSwitchButton_kswAutoAdjustTextPosition, autoAdjustTextPosition);
            ta.recycle();
        }
