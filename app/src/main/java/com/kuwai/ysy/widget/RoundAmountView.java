 ...
 */
public class RoundAmountView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public RoundAmountView(Context context, AttributeSet attrs) {
        super(context, attrs);
