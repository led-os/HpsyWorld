...
public class YsyPopWindow implements PopupWindow.OnDismissListener{
    ...
    private YsyPopWindow(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public YsyPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public YsyPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public YsyPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public YsyPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
    ...
    public static class PopupWindowBuilder{
        private YsyPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new YsyPopWindow(context);
        }
