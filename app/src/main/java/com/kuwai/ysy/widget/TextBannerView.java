...
public class TextBannerView extends RelativeLayout {
    ...
    private SetImageCallback imageCallback = null;
    ...
    public void setImageCallback(SetImageCallback setImageCallback){
        this.imageCallback = setImageCallback;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray.hasValue(R.styleable.TextBannerViewStyle_setTextSize)) {//设置文字尺寸
            ...
            mTextSize = UiUtils.px2sp(context, mTextSize);
        }
